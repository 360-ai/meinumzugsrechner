...
export const metadata: Metadata = {
  title: C_TITLE,
  description: C_DESC,
  keywords: ["Umzug Checkliste", "Umzugscheckliste", "Umzug planen Checkliste"],
  ...pageCanonical("/checklisten/"),
  openGraph: { type: "website", title: "Umzugs-Checklisten", description: C_DESC, url: "/checklisten/" },
...
const checklists = [
  ...
  {
    href: "/checklisten/uebergabeprotokoll/",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10" style={{ color: "#FF7700" }}>
    ...
    description:
      "Zustand dokumentieren, Zählerstände ablesen, Schlüssel zählen — alles für eine rechtssichere Wohnungsübergabe.",
    highlight: false,
  },
  {
    ...
    description:
      "Alle Stellen die bei einem Umzug informiert werden müssen — von Behörden über Versicherungen bis Online-Shops.",
    highlight: false,
  },
];
