      ...
      <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#5A7A8A]">
            Wählen Sie zwischen einer schnellen Orientierung und einer ausführlicheren Berechnung
            mit Inventar, Gebäudedetails und Zusatzleistungen. Das Ergebnis ist ein realistischer
            Preiskorridor für typische Marktbedingungen in Deutschland.
          </p>
        </div>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p className="text-sm leading-relaxed text-[#5A7A8A]">
            ...
            möglichen Kostenrahmen bekommen möchten. Die detaillierte Kalkulation lohnt sich, wenn
            Sie Möbel, schwierige Zugänge oder Zusatzleistungen bereits konkreter einordnen können.
          </p>
          <p className="text-sm leading-relaxed text-[#5A7A8A]">
